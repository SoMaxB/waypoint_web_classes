...
(function () {
  ...
  const DICT = {
    es: {
      ...
      "p.ft_printf.name": "ft_printf",
      "p.ft_printf.desc": "Recodifica printf(3): funciones variádicas, conversiones cspdiuxX% y formateo con ancho, precisión y flags.",
      ...
      "p.semaforos.name": "Semáforos POSIX",
    ...
    en: {
      ...
      "p.ft_printf.name": "ft_printf",
      "p.ft_printf.desc": "Recode printf(3): variadic functions, the cspdiuxX% conversions and formatting with width, precision and flags.",
      "p.redtetris.name": "Red Tetris",
      ...
      "p.semaforos.name": "POSIX Semaphores",
